    ...
    <main className="flex min-h-screen flex-col items-center justify-between ">
      <div className="flex w-full h-12">
        <div className="w-30 sm:w-60 items-center justify-center p-2">
          <p className="text-2xl mx-auto ml-10 w-fit">Logo</p>
        </div>
      ...
      <main className="flex flex-1 justify-between  w-full">
        <section className=" sm:w-60 py-4 sm:px-4 overflow-y-auto overflow-x-hidden h-screen  ">
          <div className="mb-40 sm:mx-2">
            <Sidebar />
          </div>
        </section>
